...
> **Model Notes**
>
> This model includes within-school averages of pre-test scores rather than all pre-test scores. This variable normalizes within-school variation and thus accounts for between-school variation in a different way. ??
...
> **Model Notes**
>
> This model includes *ppvt_devgm*, which is a variable in which individual pre-test scores are centered around the grand mean. This changes the meaning of the intercept to one that is adjusted for invividual-level differences and refers to someone with the control group and individuals with average pretest scores.
...
?? How does this affect the interpretation of the regression coefficients?? !!!
